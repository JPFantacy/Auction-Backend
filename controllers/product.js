...
function deleteProduct(req, res, next) {
  ...
  Product.findByIdAndDelete(id).then(res.json.bind(res)).catch(next);
}
...
function createComment(req, res, next) {
  ...
  Comment.create({ body: comment, creator: getUserId(req) }).then((comment) => {
